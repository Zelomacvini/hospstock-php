    ...
    <div class="row">
        <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse p-3">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link mb-2 rounded" href="dashboard.php"><i class="bi bi-speedometer2 me-2"></i> Dashboard</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mb-2 rounded" href="materiais.php"><i class="bi bi-box-seam me-2"></i> Estoque</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mb-2 rounded" href="movimentacoes.php"><i class="bi bi-arrow-left-right me-2"></i> Movimentações</a>
                </li>
                
                <?php if ($_SESSION['nivel_acesso'] === 'admin'): ?>
                <li class="nav-item">
                    <a class="nav-link active mb-2 rounded" href="usuarios.php"><i class="bi bi-people me-2"></i> Usuários</a>
                </li>
                <?php endif; ?>

                <li class="nav-item border-top mt-3 pt-3">
                    <a class="nav-link text-danger" href="../logout.php"><i class="bi bi-box-arrow-right me-2"></i> Sair</a>
                </li>
            </ul>
        </nav>
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="bi bi-person-plus me-1"></i> Cadastrar Usuário</button>
                    </form>
                </div>
            </div>

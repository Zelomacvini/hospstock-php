                    ...
                    <div class="card-body">
                        <form method="POST" action="">
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-3 mb-3">
                                    <button type="submit" class="btn btn-primary w-100"><i class="bi bi-save me-1"></i>
                                        Registrar</button>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped mb-0">
                                ...
                                <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($mov['tipo'] == 'entrada'): ?>
                                                        <span class="badge bg-success"><i class="bi bi-arrow-down-circle"></i>
                                                            Entrada</span>
                                                    <?php else: ?>
                                                        <span class="badge bg-warning text-dark"><i
                                                                class="bi bi-arrow-up-circle"></i> Saída</span>
                                                    <?php endif; ?>
                                                </td>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="5" class="text-center py-3">Nenhuma movimentação registrada ainda.
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>

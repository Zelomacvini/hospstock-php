...
// Gráfico 1: Materiais por Categoria (Pizza)
...
// Gráfico 2: Top 5 Materiais com Mais Estoque (Barras)
...
<head>
    ...
    <style>
        ...
        .card-icon { font-size: 2.5rem; opacity: 0.3; position: absolute; right: 10px; bottom: 10px; }
...
<script>
    ...
    // Configuração do Gráfico de Barras (Top 5 Estoque)
